package com.tcl.xpay.redis.dao;
...
/**
 * <br>
 * <b>功能：</b>redis基础DAO类<br>
 * 此类不要注入数据库的事务和sessionFactory
 */
@Component
...
/*    public void hashScan(String key, long count, IHashScanExecutor hashScanExecutor) {
        hashScanExecutor.begin();
        ...
        Cursor<Map.Entry<String, String>> curosr = hashOps.scan(key, scanOptions);
        while (curosr.hasNext()) {
            Map.Entry<String, String> entry = curosr.next();
            hashScanExecutor.execute(entry);
        }
        hashScanExecutor.end();
    }
*/
